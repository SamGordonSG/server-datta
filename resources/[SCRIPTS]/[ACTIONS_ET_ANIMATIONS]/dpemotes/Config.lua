...
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 162, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ...
  ['fr'] = {
        ...
        ['set'] = "Set (",
        ['setboundemote'] = ") pour lié votre émote?",
        ['newsetemote'] = "~w~ votre emote est maintenant liée, appuyez sur ~g~CapsLock~w~ pour l'utiliser.",
        ...
        ['pee'] = "Maintenir ~y~G~w~ pour faire pipi.",

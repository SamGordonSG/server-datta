mumbleConfig = {
    ...
    speakerRange = 2.5, -- Speaker distance in gta distance units (how close you need to be to another player to hear other players on the radio or phone)
    ...
    radioClickMaxChannel = 950, -- Set the max amount of radio channels that will have local radio clicks enabled

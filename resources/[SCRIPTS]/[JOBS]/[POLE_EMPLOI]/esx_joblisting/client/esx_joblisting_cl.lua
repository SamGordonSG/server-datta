	...
	while true do
		...
		for i=1, #Config.Zones, 1 do
			if(GetDistanceBetweenCoords(coords, Config.Zones[i].x, Config.Zones[i].y, Config.Zones[i].z, true) < Config.DrawDistance) then
				...
				DrawMarker(0, Config.Zones[i].x, Config.Zones[i].y,  Config.Zones[i].z, 0, 0, 0, 0, 0, 0, 1.0001, 1.0001, 1.0001, Config.MarkerColor.r, Config.MarkerColor.g, Config.MarkerColor.b, 165, 0, 0, 0,0)
			end
		end
	end
end)

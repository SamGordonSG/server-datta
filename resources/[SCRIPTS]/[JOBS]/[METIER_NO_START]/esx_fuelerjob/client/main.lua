...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = 'Camion Employé',  value = 'packer'},
			{label = 'Camion Gérant',  value = 'phantom3'},
			{label = 'Citerne',  value = 'tanker'},
			{label = '4x4 Patron',  value = 'sandking'},
		}
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("Société RVP")

Locales ['fr'] = {
	['judge']              	= 'T.I.G.',
	['escape_attempt']     	= 'Vous ne pouvez pas vous échaper. Vos travaux ont été rallongés.',
	...
	['action_count_suggested']      = 'nombre d\'action [entre: 10 et 40]',
	['invalid_player_id']      = 'ID invalide',
	['unjail_people']      = 'Arrter le TIG en Avance'
}

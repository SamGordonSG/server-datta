...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -196.499, y = -1315.151, z = 30.08 },
	...
	Garage = {
		Pos   = { x = -221.528, y = -1320.20, z = 29.89 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	Craft = {
		Pos   = { x = -227.83, y = -1327.69, z = 29.89 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -162.17, y = -1302.85, z = 30.29 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -156.88, y = -1308.32, z = 30.30 },

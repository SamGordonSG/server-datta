...
TriggerEvent('esx_phone:registerNumber', 'peche', _U('peche_client'), true, true)
TriggerEvent('esx_society:registerSociety', 'peche', 'Pecheur', 'society_peche', 'society_peche', 'society_peche', {type = 'private'})
...
local function Transform1(source, zone)
	...
	if PlayersTransforming[source] == true then
		...
		if zone == "TraitementSaumon" then
			...
			elseif saumonfumeQuantity > 50 then
...
AddEventHandler('esx_pecheurjob:stopTransform1', function()
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Vous pouvez ~y~fumer votre Saumon !~y~')
		PlayersTransforming[_source]=true
...
local function Transform2(source, zone)
	...
	if PlayersTransforming[source] == true then
		...
		if zone == "TraitementThon" then
			...
			elseif boitethonQuantity > 50 then
...
AddEventHandler('esx_pecheurjob:stopTransform2', function()
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Vous pouvez ~y~mettre votre Thon en boite  !~y~')
		PlayersTransforming[_source]=true
...
local function Transform3(source, zone)
	...
	if PlayersTransforming[source] == true then
		...
		if zone == "TraitementCrevette" then
			...
			elseif samoussaQuantity > 50 then

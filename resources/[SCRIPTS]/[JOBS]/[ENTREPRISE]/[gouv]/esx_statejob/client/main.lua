        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            elements = {
              ...
              {label = _U('fineopen'),			value = 'fineopen'},
            ...
            if action == 'fineopen' then					
              ...
              function(data, menu)
                ...
                if closestPlayer == -1 or closestDistance > 3.0 then
                  ...
                  TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_state', _U('Amendes'), amount)
                end
                end
              end,
              function(data, menu)
    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 300)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_statejob:annonce',result)
...
RegisterNetEvent('esx_statejob:annonce')
AddEventHandler('esx_statejob:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('esx_statejob:annoncestop')
AddEventHandler('esx_statejob:annoncestop', function()
    affichenews = false

	...
	if Config.EnableSocietyOwnedVehicles then
		...
		ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
					...
					ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.Vehicles.SpawnPoint, 27.8107, function(vehicle)
		...
		local elements = {
			{label = '4x4',  value = 'baller2'},
      {label = 'Limousine',  value = 'stretch'},
      {label = '4x4 Employer',  value = 'dubsta'},
		}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
				...
				ESX.Game.SpawnVehicle(model, Config.Zones.Vehicles.SpawnPoint, 27.8107, function(vehicle)
					local playerPed = GetPlayerPed(-1)
					TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
				end)
			end, function(data, menu)
...
function OpenSocietyActionsMenu()
  ...
  table.insert(elements, {label = 'Fouille',    value = 'fouille'})
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'fouille' then 
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('esx_bahama_mamas:craftingCoktails', data2.current.value)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_bahama_mamas', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_bahama_mamas:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bahama_mamas:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_bahama_mamas:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bahama_mamas:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_bahama_mamas:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bahama_mamas:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bahama_mamas:putFridgeStockItems', itemName, count)
            end
...
function OpenFridgeMenu2()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'put_stock' then
         OpenPutFridgeStocksMenu2()
      end

      if data.current.value == 'get_stock' then
         OpenGetFridgeStocksMenu2()
      end
...
function OpenGetFridgeStocksMenu2()

  ESX.TriggerServerCallback('esx_bahama_mamas:getFridgeStockItems2', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bahama_mamas:getFridgeStockItem2', itemName, count)
            end
...
function OpenPutFridgeStocksMenu2()
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bahama_mamas:putFridgeStockItems2', itemName, count)
            end
    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 300)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_bahama_mamas:annonce',result)
    ...
    while true do
        Citizen.Wait(1)    
          ...
          if (affichenews == true) then
            ...
            DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~r~ LE PETIT STUDIO ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('esx_bahama_mamas:annonce')
AddEventHandler('esx_bahama_mamas:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('esx_bahama_mamas:annoncestop')
AddEventHandler('esx_bahama_mamas:annoncestop', function()
    affichenews = false
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_bahama_mamas:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_bahama_mamas:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_bahama_mamas:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('esx_bahama_mamas:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_bahama_mamas:hasEnteredMarker', function(zone)
    ...
    if zone == 'BossActions2' and IsGradeBoss() then
      CurrentAction     = 'menu_boss_actions'
      CurrentActionMsg  = _U('open_bossmenu')
      CurrentActionData = {}
    end
...
AddEventHandler('esx_bahama_mamas:hasExitedMarker', function(zone)
...
function blips()
	if publicBlip == false then
		local blip = AddBlipForCoord(Config.TeleportZones.EnterBarBaha2.Pos.x, Config.TeleportZones.EnterBarBaha2.Pos.y, Config.TeleportZones.EnterBarBaha2.Pos.z)
...
if PlayerData.job ~= nil and PlayerData.job.name == 'bahama_mamas' then
      ...
      local blip2 = AddBlipForCoord(Config.Zones.Flacons.Pos.x, Config.Zones.Flacons.Pos.y, Config.Zones.Flacons.Pos.z)
...
if PlayerData.job ~= nil and PlayerData.job.name == 'bahama_mamas' then
      ...
      local blip3 = AddBlipForCoord(Config.Zones.NoAlcool.Pos.x, Config.Zones.NoAlcool.Pos.y, Config.Zones.NoAlcool.Pos.z)
      ...
      BeginTextCommandSetBlipName('STRING')
      AddTextComponentString('Sans Alcool')
      EndTextCommandSetBlipName(blip3)
      table.insert(JobBlips, blip3)
end
if PlayerData.job ~= nil and PlayerData.job.name == 'bahama_mamas' then

      local blip4 = AddBlipForCoord(Config.Zones.Apero.Pos.x, Config.Zones.Apero.Pos.y, Config.Zones.Apero.Pos.z)

      SetBlipSprite (blip4, 499)
      SetBlipDisplay(blip4, 4)
      SetBlipScale  (blip4, 1.0)
      SetBlipColour (blip4, 48)
      SetBlipAsShortRange(blip4, true)

      BeginTextCommandSetBlipName('STRING')
      AddTextComponentString('Apero')
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_bahama_mamas:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_bahama_mamas:hasExitedMarker', LastZone)
            end
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_fridge_uni' then
          OpenFridgeMenu2()
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'bahama_mamas', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'bahama_mamas')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'bahama_mamas', function(data, menu)
...
AddEventHandler('esx_bahama_mamas:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_bahama_mamas:teleportMarkers', position)
        end
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
					...
					ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.Vehicles.SpawnPoint, 131.5314, function(vehicle)
						ESX.Game.SetVehicleProperties(vehicle, vehicleProps)
						local playerPed = GetPlayerPed(-1)
						TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
					end)
      ...
      {label = '4x4 Employer',  value = 'dubsta'},
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
				...
				ESX.Game.SpawnVehicle(model, Config.Zones.Vehicles2.SpawnPoint, 131.5314, function(vehicle)
					local playerPed = GetPlayerPed(-1)
					TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
				end)
			end, function(data, menu)
...
function OpenBodySearchMenu(player)
	ESX.TriggerServerCallback('esx_bahama_mamas:getOtherPlayerData', function(data)
		local elements = {}
		...
		for i=1, #data.weapons, 1 do
			table.insert(elements, {
				label    = ESX.GetWeaponLabel(data.weapons[i].name) .. " avec " .. data.weapons[i].ammo .. " balles.",
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value then
				TriggerServerEvent('esx_bahama_mamas:confiscatePlayerItem', GetPlayerServerId(player), data.current.itemType, data.current.value, data.current.amount)

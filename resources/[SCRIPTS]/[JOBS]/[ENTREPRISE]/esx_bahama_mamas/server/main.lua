...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'bahama_mamas', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'bahama_mamas', _U('bahama_mamas_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'bahama_mamas', 'Bahama_mamas', 'society_bahama_mamas', 'society_bahama_mamas', 'society_bahama_mamas', {type = 'private'})



RegisterServerEvent('esx_bahama_mamas:getStockItem')
AddEventHandler('esx_bahama_mamas:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_bahama_mamas', function(inventory)
...
ESX.RegisterServerCallback('esx_bahama_mamas:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_bahama_mamas:putStockItems')
AddEventHandler('esx_bahama_mamas:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bahama_mamas:getFridgeStockItem')
AddEventHandler('esx_bahama_mamas:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_bahama_mamas_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_bahama_mamas:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_bahama_mamas:putFridgeStockItems')
AddEventHandler('esx_bahama_mamas:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bahama_mamas:getFridgeStockItem2')
AddEventHandler('esx_bahama_mamas:getFridgeStockItem2', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_bahama_mamas_fridge_uni', function(inventory)
...
ESX.RegisterServerCallback('esx_bahama_mamas:getFridgeStockItems2', function(source, cb)
...
RegisterServerEvent('esx_bahama_mamas:putFridgeStockItems2')
AddEventHandler('esx_bahama_mamas:putFridgeStockItems2', function(itemName, count)
...
RegisterServerEvent('esx_bahama_mamas:buyItem')
AddEventHandler('esx_bahama_mamas:buyItem', function(itemName, price, itemLabel)
    ...
    if societyAccount ~= nil and societyAccount.money >= price then
        if xPlayer.canCarryItem(itemName,tonumber(qtty)) then
...
RegisterServerEvent('esx_bahama_mamas:craftingCoktails')
AddEventHandler('esx_bahama_mamas:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_bahama_mamas:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_bahama_mamas', function(store)
...
ESX.RegisterServerCallback('esx_bahama_mamas:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bahama_mamas:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bahama_mamas:getPlayerInventory', function(source, cb)
...
RegisterServerEvent('esx_bahama_mamas:annonce')
AddEventHandler('esx_bahama_mamas:annonce', function(result)
	local _source  = source
	local xPlayer  = ESX.GetPlayerFromId(_source)
	...
	for i=1, #xPlayers, 1 do
 		...
 		TriggerClientEvent('esx_bahama_mamas:annonce', xPlayers[i],text)
	end
	...
	for i=1, #xPlayers, 1 do
 		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
 		TriggerClientEvent('esx_bahama_mamas:annoncestop', xPlayers[i])
	end

end)


ESX.RegisterServerCallback('esx_bahama_mamas:getOtherPlayerData', function(source, cb, target)
...
RegisterServerEvent('esx_bahama_mamas:confiscatePlayerItem')
AddEventHandler('esx_bahama_mamas:confiscatePlayerItem', function(target, itemType, itemName, amount)
	local _source = source
	local sourceXPlayer = ESX.GetPlayerFromId(_source)
	local targetXPlayer = ESX.GetPlayerFromId(target)

	if sourceXPlayer.job.name ~= 'bahama_mamas' then
		print(('esx_bahama_mamas: %s attempted to confiscate!'):format(xPlayer.identifier))
		return
	end

	if itemType == 'item_standard' then

		TriggerClientEvent('esx:showNotification', _source, 'Vous ne pouvez pas prendre cela !')
	...
	elseif itemType == 'item_weapon' then
		...
		TriggerClientEvent('esx:showNotification', _source, "Vous avez pris l'arme de l'individu merci de lui restituer une fois sorti du bar !")
		TriggerClientEvent('esx:showNotification', target,  "Le videur vous à confisqué votre arme, n'oubliez pas de la récupérer en sortant !")

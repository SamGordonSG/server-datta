Locales['fr'] = {
    ...
    ['bahama_mamas_fridge_stock']     = 'Frigo',
    ...
    -- Phone  
    ['bahama_mamas_phone']            = 'Bars',
    ['bahama_mamas_customer']         = 'Citoyen',
    ...
    -- Fouille
    ['you_confiscated']          = 'On vous à confisqué ',
    ['got_confiscated']          = 'Cet objet a été confisqué ',
    ['you_confiscated_account']          = 'On vous à confisqué ',
    ['got_confiscated_account']          = 'Cette liasse de billet à été',
    ['you_confiscated_weapon']          = 'On vous à confisqué cette arme ',
    ['got_confiscated_weapon']          = 'Cette arme à été confisquée', 
    ['confiscate_dirty']                 = "Prendre la liasse de billets",
    ['guns_label']                       = 'Armes',
    ['confiscate_weapon']                = 'Confisquer armes',
    ['inventory_label']                  = 'Inventaire',
    ['confiscate_inv']                   = 'Confisquer Objet',
    ['search']                           = 'Fouiller', 

	...
	while true do
		...
		if DoesEntityExist(cachedData["storeOwner"]) then
			...
			if dstCheck < 3.0 then
				...
				local displayText = not IsEntityDead(cachedData["storeOwner"]) and "Appuyez sur ~INPUT_CONTEXT~ pour vendre votre poisson au propriétaire." or "Le propriétaire est inconscient et ne peux donc pas parler."

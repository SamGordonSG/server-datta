Locales['fr'] = {
  ...
  ['give_keys_menu'] = 'Donner les clés de votre logement',
  ['take_away_keys'] = 'Reprendre la clé de votre logement',
  ['give_keys'] = 'Gestion des clés',
  ['removed_keys_all'] = 'Vous avez récupéré vos clés',
  ['keys_received'] = "Vous avez reçu les clé de l'appartement",
  ['gave_keys'] = "Vous avez donné les clé de l'appartement",
}

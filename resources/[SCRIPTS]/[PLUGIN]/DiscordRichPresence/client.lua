Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(714916648305557626)
		SetDiscordRichPresenceAsset('amazing2')
        SetDiscordRichPresenceAssetText('Amazing V, Rejoignez-nous !')
        SetDiscordRichPresenceAssetSmallText('https://discord.gg/K6PBHXG')
		Citizen.Wait(60000)

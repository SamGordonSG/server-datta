...
ESX.RegisterUsableItem('donut', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, 'Vous avez mangé 1x donut')
end)
...
ESX.RegisterUsableItem('taco4', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, 'Vous avez mangé 1x taco')
end)
...
ESX.RegisterUsableItem('monster', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, 'Vous avez bu 1x Monster Energy')
end)
            ...
            if copcount >= mincops then
                if method == 1 then
                    ...
                    if item >= 1 then
                        ...
                        cb("Vous n'avez pas de charge thermique.")
                    end
                ...
                cb("Il doit y avoir au moins "..mincops.." policier en ville.")
            end
        else
            cb(math.floor((cooldown - (os.time() - lastrobbed)) / 60)..":"..math.fmod((cooldown - (os.time() - lastrobbed)), 60).." restant avant le prochaine possibilité.")
        end
    else
        cb("Braquage déjà en cours.")
    end
end)

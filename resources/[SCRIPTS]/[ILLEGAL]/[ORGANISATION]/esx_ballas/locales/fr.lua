Locales['fr'] = {
  ...
  ['owner'] = 'Propriétaire : ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'Ballas - Prendre Arme',
  ['put_weapon_menu'] = 'Ballas - Déposer Arme',
  ['buy_weapon_menu'] = 'Ballas - Acheter Armes',
  ...
  ['quantity'] = 'Quantité',
  ['get_stock'] = 'Ballas - Prendre Objet',
  ['put_stock'] = 'Ballas - Déposer Objet',
  ['gradeorg'] = 'Grade',
  -- Notifications
  ['from'] = '~s~ à ~b~',

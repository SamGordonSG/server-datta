...
function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
	  ...
	  if PlayerData.org.name == 'ballas' and PlayerData.org.gradeorg_name == 'boss' then
	  ...
	  for i=1, #Config.BallasStations[station].AuthorizedWeapons, 1 do
		local weapon = Config.BallasStationss[station].AuthorizedWeapons[i]
...
function OpenGetWeaponMenu2()
	...
	ESX.TriggerServerCallback('esx_ballas:getArmoryWeapons2', function(weapons)
	  ...
	  ESX.UI.Menu.Open(
		...
		function(data, menu)
		  ...
		  ESX.TriggerServerCallback('esx_ballas:removeArmoryWeapon2', function()
			OpenGetWeaponMenu2()
		  end, data.current.value)
...
function OpenPutWeaponMenu2()
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		ESX.TriggerServerCallback('esx_ballas:addArmoryWeapon2', function()
		  OpenPutWeaponMenu2()
...
function OpenOrganisationInventoryMenu()
	...
	ESX.TriggerServerCallback('esx_ballas:getOrganisationInventory', function(inventory)
  ...
  function OpenOrganisationInventoryMenu2()
	...
	ESX.TriggerServerCallback('esx_ballas:getOrganisationInventory2', function(inventory)
	  ...
	  ESX.UI.Menu.Open(
		...
		function(data, menu)
		  ...
		  if data.current.type == 'item_weapon' then
			...
			TriggerServerEvent('esx_ballas:getItem2',  data.current.type, data.current.value, data.current.ammo)
			...
			ESX.UI.Menu.Open(
			  ...
			  function(data2, menu)
				...
				if quantity == nil then
				  ...
				  TriggerServerEvent('esx_ballas:getItem2', data.current.type, data.current.value, quantity)
	  ...
	  ESX.UI.Menu.Open(
		...
		function(data, menu)
		  ...
		  if data.current.type == 'item_weapon' then
			...
			TriggerServerEvent('esx_ballas:putItem2',  data.current.type, data.current.value, data.current.ammo)
			...
			ESX.UI.Menu.Open(
			  ...
			  function(data2, menu)
				...
				TriggerServerEvent('esx_ballas:putItem2', data.current.type, data.current.value, tonumber(data2.value))

...
AddEventHandler('esx_mafia:getItem', function( type, item, count)
  ...
  if type == 'item_account' then
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'mafia_black_money',  function(account)
...
RegisterServerEvent('esx_mafia:getItem2')
AddEventHandler('esx_mafia:getItem2', function( type, item, count)
  ...
  if type == 'item_standard' then
    ...
    TriggerEvent('esx_addoninventory:getSharedInventory', 'organisation_mafiaboss',  function(inventory)
...
RegisterServerEvent('esx_mafia:putItem2')
AddEventHandler('esx_mafia:putItem2', function( type, item, count)
...
ESX.RegisterServerCallback('esx_mafia:getArmoryWeapons2', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'organisation_mafiaboss', function(store)
...
ESX.RegisterServerCallback('esx_mafia:addArmoryWeapon2', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_mafia:removeArmoryWeapon2', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_mafia:getOrganisationInventory', function(source, cb)
...
-------------------
ESX.RegisterServerCallback('esx_mafia:getOrganisationInventory2', function(source, cb)

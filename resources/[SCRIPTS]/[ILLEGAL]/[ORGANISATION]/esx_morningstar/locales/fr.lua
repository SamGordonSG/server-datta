Locales['fr'] = {
  ...
  ['owner'] = 'Propriétaire : ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'Atlas - Prendre Arme',
  ['put_weapon_menu'] = 'Atlas - Déposer Arme',
  ['buy_weapon_menu'] = 'Atlas - Acheter Armes',
  ...
  ['quantity'] = 'Quantité',
  ['get_stock'] = 'Atlas - Prendre Objet',
  ['put_stock'] = 'Atlas - Déposer Objet',
  -- Notifications
  ['from'] = '~s~ à ~b~',

Locales['fr'] = {
  ...
  ['owner'] = 'Propriétaire : ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'Cartel - Prendre Arme',
  ['put_weapon_menu'] = 'Cartel - Déposer Arme',
  ['buy_weapon_menu'] = 'Cartel - Acheter Armes',
  ...
  ['quantity'] = 'Quantité',
  ['get_stock'] = 'Cartel - Prendre Objet',
  ['put_stock'] = 'Cartel - Déposer Objet',
  -- Notifications
  ['from'] = '~s~ à ~b~',

...
RegisterServerEvent('esx_biker:getItem')
AddEventHandler('esx_biker:getItem', function( type, item, count)
  ...
  if type == 'item_account' then
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'biker_black_money',  function(account)
...
RegisterServerEvent('esx_biker:getItem2')
AddEventHandler('esx_biker:getItem2', function( type, item, count)
  ...
  if type == 'item_standard' then
    ...
    TriggerEvent('esx_addoninventory:getSharedInventory', 'organisation_bikerboss',  function(inventory)
...
RegisterServerEvent('esx_biker:putItem')
AddEventHandler('esx_biker:putItem', function( type, item, count)
...
RegisterServerEvent('esx_biker:putItem2')
AddEventHandler('esx_biker:putItem2', function( type, item, count)
...
ESX.RegisterServerCallback('esx_biker:getArmoryWeapons2', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'organisation_bikerboss', function(store)
...
ESX.RegisterServerCallback('esx_biker:addArmoryWeapon2', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_biker:removeArmoryWeapon2', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_biker:getOrganisationInventory', function(source, cb)
...
-------------------
ESX.RegisterServerCallback('esx_biker:getOrganisationInventory2', function(source, cb)

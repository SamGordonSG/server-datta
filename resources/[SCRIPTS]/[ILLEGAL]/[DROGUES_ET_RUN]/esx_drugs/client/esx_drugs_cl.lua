...
-- dure Effect
RegisterNetEvent('esx_drugs:onPoth')
AddEventHandler('esx_drugs:onPoth', function()
...
-- violente Effect
RegisterNetEvent('esx_drugs:onPotj')
AddEventHandler('esx_drugs:onPotj', function()
...
AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, crackNbr, crackpNbr, ketamineNbr, ketaminepNbr, ecstasyNbr, ecstasypNbr, billetNbr, billetpNbr, opiumNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	      = cokeNbr

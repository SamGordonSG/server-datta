...
Config.cdTime = 7200000 -- global cooldown in ms. Set to 20 minutes by default - (https://www.timecalculator.net/minutes-to-milliseconds)
...
Config.randBrick = math.random(5,10) -- change the numbers to how much coke you want players to receive after breaking down bricks

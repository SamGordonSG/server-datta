...
cfg = {
	...
	weaponsDamageMultiplier = 0.51,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
...
repairCfg = {
	...
	fixMessages = {
		"Vous avez remis le bouchon d'huile",
		"Vous avez stoppé la fuite avec un chewing gum",
		"Vous avez réparé la jauge d'huile avec du scotch",
		"Vous avez resserré le bouchon d'huile et stoppé la fuite",
		"Vous avez tapé sur le moteur et il a redémarré par magie",
		"Vous avez retiré de la rouille des bougies",
		"Vous avez gueulé sur le véhicule et, apparemment, ça fonctionne!"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Vous avez checké le niveau d'huile, c'est tout bon",
		"Vous avez jeté un oeil sur le moteur, tout semble ok",
		"Vous vous êtes assuré que les fils de bougies sont bien en place",
		"Vous avez monté le son de la radio. Ca couvre le bruit du moteur...",
		"Vous avez mis du nettoyant injecteurs, mais ça ne change pas grand chose",
		"Ne jamais touché sans connaitre à ce qu'il parait. Hé bien, ç'est vrai!"
	},
	noFixMessageCount = 6
}

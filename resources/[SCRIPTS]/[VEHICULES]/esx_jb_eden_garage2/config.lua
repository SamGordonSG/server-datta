...
Config.SwitchGaragePrice		= 50 -- price to pay to switch vehicles in garage
...
Config.Garages = {
	...
	Garage_Concess = {
		Pos = {x = -738.13934326172,y = -61.007900238037,z = 41.753074645996},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = -750.49,y = -67.22,z = 41.75},
			Heading = 117.13,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x = -736.57,y = -73.32,z = 41.74},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},

...
function SpawnVehicle(vehicleProps, garage, KindOfVehicle)
	ESX.Game.SpawnVehicle(vehicleProps.model, {
		...
		z = garage.SpawnPoint.Pos.z + 1											
			...
			if KindOfVehicle == 'brasseur' or KindOfVehicle == 'vigne' or KindOfVehicle == 'ferme' or KindOfVehicle == 'orpailleur' or KindOfVehicle == 'peche' or KindOfVehicle == 'fueler' or KindOfVehicle == 'mechanic' or KindOfVehicle == 'unicorn' or KindOfVehicle == 'bahama_mama' or KindOfVehicle == 'bucheron' or KindOfVehicle == 'tabac' or KindOfVehicle == 'foodtruck' then

...
-- GENERAL SETTING
Config.SuccesChance  = 100   --How many % of chance to unlock a car. (0-100)
...
Config.CallCopsChance       = 100   --How many % of chance for the car alarm start AND call cops. (0-100)
...
Config.WaitTime          = 120     --Set how many time in minutes before another vehicle can be sell to the pawnshop (0-9999...)
Config.ExpireVehicle     = 0     --Set how many days the player have to buy back ther vehicle before all can buy it
Config.ResellPercentage  = 10    --Percent of original car price player get from selling car (1-100)
Config.RebuyPercentage   = 30    --Percent of original car price player need to buy back the car (1-100)
...
--ITEMS PRICES
Config.Prices = {
  {name = "hammerwirecutter", price = 10000},
  {name = "unlockingtool",    price = 10000},
  {name = "jammer",           price = 10000},
  {name = "alarm1",           price = 10000},
  {name = "alarm2",           price = 20000},
  {name = "alarm3",           price = 30000},
  {name = "alarminterface",   price = 10000}
}
...
Config.Zones = {
  ...
  {
	Name  = "PawnShop",
	OnMap = false,		--Si true = Pawn Shop visible sur la map

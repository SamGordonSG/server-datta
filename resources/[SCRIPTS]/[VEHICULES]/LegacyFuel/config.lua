...
Config.Strings = {
	ExitVehicle = "Descendez du véhicule pour faire le plein",
	...
	JerryCanFull = "Jerrycan plein",
	TotalCost = "Prix",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour prendre le jerrycan"

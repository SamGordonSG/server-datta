...
function ManageFuelUsage(vehicle)
	if not DecorExistOn(vehicle, Config.FuelDecor) then
		SetFuel(vehicle, math.random(800, 800) / 10)
	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				...
				DrawAdvancedText(0.90 - x, 0.70 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.85 - x, 0.71 - y, 0.005, 0.0028, 0.4, "               Fuel", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end

Config = {
    ...
    Locations = {
        ...
        [21] = {
            ["etageres"] = {
                {["x"] = -1034.76, ["y"] = -2751.16, ["z"] = 14.59, ["value"] = "checkout"},
                {["x"] = -1037.81, ["y"] = -2749.32, ["z"] = 14.59, ["value"] = "diverse"},
            },
            ["blip"] = {
                ["x"] = -1037.81, ["y"] = -2749.32, ["z"] = 14.59
            },
            ["caissier"] = {
                ["x"] = -1033.73, ["y"] = -2752.00, ["z"] = 14.59 -0.99, ["h"] = 22.80
            },
        },
    },
    ...
    U can specify the hash of the caissier like this:
        ["caissier"] = {
    ...
    Locales = {
        ...
        ["drinks"] = "Boissons",
        ["snacks"] = "Snacks",
        ["readymeal"] = "Plat préparé",
        ["diverse"] = "Divers",
    },

    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 8},
            {label = "Fanta Exotic", item = "fanta", price = 8}, 
            {label = "Sprite", item = "sprite", price = 8},
            {label = "Loka Crush", item = "loka", price = 7}, 
            {label = "Eau", item = "water", price = 5},
            {label = "Lait", item = "milk", price = 5},
        },
        ["snacks"] = {
            {label = "Boules de fromage", item = "cheesebows", price = 8}, 
            {label = "Amazing chips", item = "chips", price = 5}, 
            {label = "Marabou chocolat", item = "marabou", price = 6}, 
        },
        ["readymeal"] = {
            {label = "Pizza", item = "pizza", price = 17},
            {label = "Bacon burger", item = "burger", price = 15},
            {label = "Pates Carbonara", item = "pastacarbonara", price = 16},
            {label = "Sandwich au jambon", item = "macka", price = 12},
            {label = "Pain", item = "bread", price = 10},
        },
        ["diverse"] = {
            {label = "Briquet", item = "lighter", price = 20},
            {label = "Cigarette", item = "cigarett", price = 5},
            {label = "Tiquet de lotterie", item = "lotteryticket", price = 15},
            {label = "Telephone", item = "phone", price = 250},
            {label = "Jumelles", item = "jumelles", price = 100},
            {label = "Leurres", item = "james_fishingbait", price = 2},
            {label = "Canne à peche", item = "james_fishingrod", price = 100},

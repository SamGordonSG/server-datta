...
AddEventHandler('esx_spectate:kick', function(target, msg)
	...
	if xPlayer.getGroup() ~= 'user' then
		...
		print(('esx_spectate: %s tente de kick un joueur!'):format(xPlayer.identifier))
		DropPlayer(source, "esx_spectate: Vous n\'etes pas autorisé à kick un joueur, Idiot!")
	end
end)
...
ESX.RegisterServerCallback('esx_spectate:getOtherPlayerData', function(source, cb, target)
        ...
        if xPlayer ~= nil then
            ...
            local height = user['height'] .. " Centimetre"

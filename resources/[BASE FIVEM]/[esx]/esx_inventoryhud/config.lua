...
Config.OpenControl = 83 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.

-- List of item names that will close ui when used
Config.CloseUiItems = {"headbag", "fishingrod","bait", "turtle","badgepolice","cagoule","handcuffs","tunerchip","defribrillateur","repairkit","tuning_laptop","rope", "alarm", "alarm2", "alarm3", "jammer", "unlockingtool", "hammerwirecutter", "meth_pooch", "coke_pooch", "weed", "weed_pooch", "malbora", "gitane", "fixkit"}

 -- Limite, 30 kg par personne
Config.Limit = 30000

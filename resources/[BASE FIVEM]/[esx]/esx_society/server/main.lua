...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
	...
	if isBoss then
		...
		playerMsg    = " Exploit de esx_society. Si vous pensez que c'est une erreur, veuillez consulter notre Discord : https://discord.gg/DU6FamW"
		print(notifMsg)
		DropPlayer(source, 'Lua Execution/Mod Menu')
		TriggerClientEvent('chatMessage', -1, '^3[Chat]', {255, 0, 0}, "^3" ..xPlayer.name.. "^1 a été kick pour avoir tenté de se mettre Patron d'un métier.")

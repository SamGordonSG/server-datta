			...
			for i=1, #results, 1 do
				table.insert(employees, {
					...
					org = {
						...
						gradeorg_name  = Org[results[i].org].gradeorg[tostring(results[i].org_gradeorg)].name,
						gradeorg_label = Org[results[i].org].gradeorg[tostring(results[i].org_gradeorg)].label
					}
				})
			end
			...
			for i=1, #result, 1 do
				table.insert(employees, {
					...
					org = {
						...
						gradeorg_name  = Org[result[i].org].gradeorg[tostring(result[i].org_gradeorg)].name,
						gradeorg_label = Org[result[i].org].gradeorg[tostring(result[i].org_gradeorg)].label
					}
				})
			end

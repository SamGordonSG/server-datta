...
function OpenPersonnelMenu()
	...
	ESX.TriggerServerCallback('NB:getUsergroup', function(group)
		...
		table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://image.flaticon.com/icons/png/512/57/57134.png"> ', value = 'menuperso_moi'})
		table.insert(elements, {label = '<img style="max-width:50px; max-height:50px;" src="https://i.imgur.com/CSmP9QD.png"> ', value = 'menuperso_actions'})
		--table.insert(elements, {label = '<img style="max-width:50px; max-height:50px;" src="https://cdn2.iconfinder.com/data/icons/logistics-delivery-5-1/66/245-512.png"> ', value = 'menuperso_inv'})

		if (IsInVehicle()) then
			local vehicle = GetVehiclePedIsIn( GetPlayerPed(-1), false )
			if ( GetPedInVehicleSeat( vehicle, -1 ) == GetPlayerPed(-1) ) then
				table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://image.flaticon.com/icons/png/512/55/55283.png"> ',	value = 'menuperso_vehicule'})
			end
		end
		--table.insert(elements, {label = '🌍 ',			value = 'menuperso_gpsrapide'})
		
		if PlayerData.job.grade_name == 'boss' then
			table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/YbeL1yx.png"> ',	value = 'menuperso_grade'})
		end
				
		if playergroup == 'mod' or playergroup == 'admin' or playergroup == 'superadmin' or playergroup == 'owner' then
			table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/bHQCXgN.png"> ',	value = 'menuperso_modo'})
		end
		
		ESX.UI.Menu.Open(
			'defaultt', GetCurrentResourceName(), 'menu_perso',
			{
			    css = 'perso',
				title    = '',
				align    = 'top-left',
			...
			function(data, menu)
				...
				if data.current.value == 'menuperso_modo' then
					ESX.UI.Menu.Open(
						'defaultt', GetCurrentResourceName(), 'menuperso_modo',
						{
						css = 'Modo',
							title    = 'Modération',
							align    = 'top-left',
				...
				if data.current.value == 'menuperso_moi' then
					...
					table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://image.flaticon.com/icons/png/512/972/972601.png"> ',	value = 'menuperso_moi_factures'})
					table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/vsYEbPd.png"> ',	value = 'menuperso_moi_idcard'})
					--table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://toppng.com/uploads/preview/sim-card-icon-sim-icon-11553496409ie27iwqyqa.png"> ',	value = 'menuperso_moi_cartesim'})
					table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/7DHkIjJ.png"> ',  value = 'menuperso_moi_clefs'})
					--table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://cdn.iconscout.com/icon/premium/png-512-thumb/necktie-115-984653.png"> ',	value = 'menuperso_moi_accessoire'})
					--table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://img.icons8.com/all/500/t-shirt--v1.png"> ',	value = 'menuperso_moi_vetements'})
					table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://cdn3.iconfinder.com/data/icons/transport-39/100/feb-transport-go-37-512.png"> ',  value = 'menuperso_moi_givevehicles'})
					table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/DQ54RU3.png"> ',  value = 'menuperso_moi_giveboat'})
					table.insert(elements, {label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/fLtbQTw.png"> ',  value = 'menuperso_moi_giveair'})  

					ESX.UI.Menu.Open(
						
						'defaultt', GetCurrentResourceName(), 'menuperso_moi',
						{
						css = 'meconcernant',
							title    = 'Me concernant',
							align    = 'top-left',
						...
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_moi_clefs' then
								...
								local elements = {}
									...
									table.insert(elements, {label = 'Mes Clés', 				value = 'key'})
									table.insert(elements, {label = 'Mes clés société',  	value = 'keysociete'})
									--table.insert(elements, {label = 'Cacher / voir l\'interface',	value = 'hud'})

								ESX.UI.Menu.Open(
					
								'defaultt', GetCurrentResourceName(), 'mescle',
								{
								css='mescles',
								title    = 'Mes clés',
								align    = 'left',
								...
								if data3.current.value == 'key' then
									TriggerEvent('NB:closeAllSubMenu')
									TriggerEvent('NB:closeAllMenu')						
									TriggerEvent("esx_menu:key")
								end
														
								if data3.current.value == 'keysociete' then	
									TriggerEvent('NB:closeAllSubMenu')
									TriggerEvent('NB:closeAllMenu')						
									TriggerEvent("esx_menu:key2")
								end							
							...
							if data2.current.value == 'menuperso_moi_givevehicles' then
								TriggerEvent('esx_givevehicles:car', source)
							end

							if data2.current.value == 'menuperso_moi_giveboat' then
								TriggerEvent('esx_givevehicles:boat', source)
							end

							if data2.current.value == 'menuperso_moi_giveair' then
								TriggerEvent('esx_givevehicles:air', source)
							end
				...
				if data.current.value == 'menuperso_actions' then
					...
					ESX.UI.Menu.Open(
						'defaultt', GetCurrentResourceName(), 'menuperso_actions',
						{
						css = 'anim',
							title    = 'Actions',
							align    = 'top-left',
							elements = {
								...
								{label = 'Animations Partagées',  value = 'menuperso_actions_ptg'},
							},
						},
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_actions_Salute' then
								ESX.UI.Menu.Open(
									'defaultt', GetCurrentResourceName(), 'menuperso_actions_Salute',
									{
									css = 'anim',
							...
							if data2.current.value == 'menuperso_actions_Humor' then
								ESX.UI.Menu.Open(
									'defaultt', GetCurrentResourceName(), 'menuperso_actions_Humor',
									{
									css = 'anim',
							...
							if data2.current.value == 'menuperso_actions_Travail' then
								ESX.UI.Menu.Open(
									'defaultt', GetCurrentResourceName(), 'menuperso_actions_Travail',
									{
									css = 'anim',
							...
							if data2.current.value == 'menuperso_actions_Festives' then
								ESX.UI.Menu.Open(
									'defaultt', GetCurrentResourceName(), 'menuperso_actions_Festives',
									{
									css = 'anim',
							...
							if data2.current.value == 'menuperso_actions_Others' then
								ESX.UI.Menu.Open(
									'defaultt', GetCurrentResourceName(), 'menuperso_actions_Others',
									{
									css = 'anim',
										...
										elements = {
											...
											{label = 'Arrestation',     value = 'menuperso_actions_Others_arrestation'},
										},
									},
									function(data3, menu3)
							...
							if data2.current.value == 'menuperso_actions_ptg' then
								TriggerEvent('NB:closeAllSubMenu')
								TriggerEvent('NB:closeAllMenu')
				...
				--[[if data.current.value == 'menuperso_inv' then
					TriggerEvent('NB:closeAllSubMenu')
					TriggerEvent('NB:closeAllMenu')
					TriggerEvent('NB:closeMenuKey')
				...
				--[[if data.current.value == 'menuperso_gpsrapide' then
					ESX.UI.Menu.Open(
						'defaultt', GetCurrentResourceName(), 'menuperso_gpsrapide',
						{
						css = 'gps',
							title    = 'GPS Rapide',
							align    = 'top-left',
						...
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_gpsrapide_poleemploi' then
								...
								TriggerEvent("esx_ascenseur:notify", "CHAR_CALL911", 1, "GPS", 'GPS Activer', "la destination viens d'être ajouter à votre GPS")
				...
				if data.current.value == 'menuperso_grade' then
					ESX.UI.Menu.Open(
						'defaultt', GetCurrentResourceName(), 'menuperso_grade',
						{
						css = 'patron',
							title    = 'Gestion d\'entreprise',
							align    = 'top-left',
							elements = {
								{label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/7CsoeLL.png"> ', value = 'menuperso_grade_recruter'},
								{label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/R6Zd0Xr.png"> ', value = 'menuperso_grade_virer'},
								{label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/rHvD7D0.png"> ', value = 'menuperso_grade_promouvoir'},
								{label = '<img style="max-width: 50px; max-height:50px;" src="https://i.imgur.com/94iCQm5.png"> ',  value = 'menuperso_grade_destituer'}
							},
						},
						function(data2, menu2)
...
function OpenVehiculeMenu()
	...
	ESX.UI.Menu.Open(
		'defaultt', GetCurrentResourceName(), 'menuperso_vehicule',
		{
		css = 'vehicle',
			img    = 'menu_vehicule',
			-- title    = 'Véhicule',
...
function openMenu()
    ESX.UI.Menu.CloseAll()
    ESX.UI.Menu.Open(
	'defaultt', GetCurrentResourceName(), 'id_card_menu',
	{css='meconcernant',
		title    = 'ID menu',
		elements = {
	...
	function(data, menu)
		...
		elseif val == 'checkFirearms' then
			...
			TriggerServerEvent('jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(player), 'weapon')
			  ...
			  ESX.ShowNotification('Pas de citoyen à proximité')
			end
		end
	end,
	function(data, menu)

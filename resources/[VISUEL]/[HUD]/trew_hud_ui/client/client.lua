...
AddEventHandler('trew_hud_ui:setInfo', function(info)
	...
	SendNUIMessage({ action = 'setText', id = 'org', value = info['org'] })
	...
	if ESX.PlayerData.org ~= nil then
		if ESX.PlayerData.org.gradeorg_name ~= nil and ESX.PlayerData.org.gradeorg_name == 'boss' then
			if (Config.ui.showOrganisationMoney == true) then
				SendNUIMessage({ action = 'element', task = 'enable', value = 'organisation' })
			end
			ESX.TriggerServerCallback('esx_organisation:getOrganisationMoney', function(money)
				SendNUIMessage({ action = 'setMoney', id = 'organisation', value = money })
			end, ESX.PlayerData.org.name)
		else
			SendNUIMessage({ action = 'element', task = 'disable', value = 'organisation' })
		end
	end
...
RegisterCommand('toggleui', function()
	if not toggleui then
		...
		SendNUIMessage({ action = 'element', task = 'disable', value = 'society' })
		SendNUIMessage({ action = 'element', task = 'disable', value = 'org' })
		SendNUIMessage({ action = 'element', task = 'disable', value = 'organisation' })
		...
		if (Config.ui.showOrg == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'org' })
		end
		if (Config.ui.showOrganisationMoney == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'organisation' })
		end
